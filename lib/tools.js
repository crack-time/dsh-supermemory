import { activeContainer, argString, requireUpstream, setActiveContainer } from './config.js';
import { discoverContainers, fetchProfile, profileCounts } from './containers.js';
/**
...
function makeSelectMemoryTool(scope, ctx) {
    return {
        ...
        description: 'Switch the active memory space for this session. Use it when the user explicitly asks ' +
