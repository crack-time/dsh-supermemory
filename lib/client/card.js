...
export function SupermemorySettingsCard(props) {
    ...
    async function commit() {
        ...
        if (manageServer !== (server?.manageServer ?? false))
            patch.manageServer = manageServer;
    ...
    async function serverAction(which) {
        setServerBusy(true);
        setServerActionErr(false);
        setStatus(null);
        try {
