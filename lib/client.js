...
function SupermemorySettingsCard(props) {
	...
	const { open, baseUrl, apiKey, serverPath, openaiApiKey, openaiBaseUrl, openaiModel, recallEnabled, recallTopK, recallThreshold, managed, server, saving, saveFailed, justSaved, testing, status, loadErr, dirty, mgtText, setOpen, setBaseUrl, setApiKey, setServerPath, setOpenaiApiKey, setOpenaiBaseUrl, setOpenaiModel, setRecallEnabled, setRecallTopK, setRecallThreshold, setSaveFailed, commit, runTest } = useSupermemoryCard({
		t: txt,
		applyPatch
	});
