...
function SupermemorySettingsCard(props) {
	...
	*/
	async function loadContainers(force = false) {
		...
		try {
			const res = await fetch("/plugins/@crack/dsh-supermemory/api/containers", { cache: "no-store" });
			if (!res.ok) {
				setContainers([]);
				return;
			}
			...
			children: [
				...
				(0, react_jsx_runtime.jsxs)("label", {
					...
					children: [
						(0, react_jsx_runtime.jsx)("span", {
							className: "sm-settings-label",
							children: txt("activeContainer")
						}),
						(0, react_jsx_runtime.jsxs)("div", {
							className: "sm-settings-container-row",
							children: [(0, react_jsx_runtime.jsxs)("select", {
								...
								children: [containersLoading ? (0, react_jsx_runtime.jsx)("option", {
									value: "",
									children: txt("loadingContainers")
								}) : containers.length === 0 ? (0, react_jsx_runtime.jsx)("option", {
									value: "",
									children: txt("noContainers")
								}) : containers.map((c) => (0, react_jsx_runtime.jsxs)("option", {
									value: c.tag,
									children: [
										c.tag,
										" — ",
										txt("containerStats").replace("{static}", String(c.staticCount)).replace("{dynamic}", String(c.dynamicCount))
									]
								}, c.tag)), (0, react_jsx_runtime.jsx)("option", {
									value: "__new__",
									children: txt("createNew")
								})]
							}), creatingContainer ? (0, react_jsx_runtime.jsxs)("div", {
								className: "sm-settings-container-new",
								children: [
									(0, react_jsx_runtime.jsx)("input", {
										type: "text",
										...
										onKeyDown: (e) => {
											if (e.key === "Enter" && newContainerName.trim()) {
												saveContainer(newContainerName.trim().toLowerCase().replace(/[^a-z0-9_-]/g, "-"));
												setCreatingContainer(false);
												setNewContainerName("");
						...
						(0, react_jsx_runtime.jsx)("span", {
							className: "sm-settings-hint",
							children: txt("activeContainerHint")
						})
					]
				}),
